...
* [Liquibase Migration](https://docs.spring.io/spring-boot/docs/3.0.0-M4/reference/htmlsingle/#howto.data-initialization.migration-tool.liquibase)
...
* [Prometheus](https://docs.spring.io/spring-boot/docs/3.0.0-M4/reference/htmlsingle/#actuator.metrics.export.prometheus)
